...
echo
echo Continue to create GitHub TAP GitOps Repo tap-1
echo     https://github.com/tanzupro/tap-1
echo
...
git add .
git commit -am "."
gh repo create tap-1 --private
git remote add origin https://github.com/tanzupro/tap-1
git branch -M main
